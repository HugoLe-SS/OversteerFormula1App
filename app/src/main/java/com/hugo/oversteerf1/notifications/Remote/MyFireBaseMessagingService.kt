...
import com.hugo.oversteerf1.notifications.Remote.Utils.NotificationUtils
...
class MyFirebaseMessagingService : FirebaseMessagingService() {
    ...
    override fun onNewToken(token: String) {
        ...
        AppLogger.d(TAG, "Refreshed FCM token: $token")
        ...
        CoroutineScope(Dispatchers.IO).launch {
            ...
            if (userId != null) {
                ...
                Log.d(TAG, "User ID is null, cannot upload refreshed token.")
            }
        }
    ...
    override fun onMessageReceived(remoteMessage: RemoteMessage) {
        ...
        if (remoteMessage.data.isNotEmpty()) {
            ...
            val title = remoteMessage.data["title"] ?: getString(R.string.app_name) // Default title
    ...
    private fun sendNotification(title: String, messageBody: String, raceId: String?) {
        ...
        val notificationBuilder = NotificationCompat.Builder(this, RACE_REMINDER_CHANNEL_ID)
            .setSmallIcon(com.hugo.schedule.R.drawable.ic_checkered_flag)
